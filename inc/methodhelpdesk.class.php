...
//               $output          = $data['name'];
   ...
   * - debug : mode debug
   *   Renvoie une ligne de r�sultat contenant les param�tres et la requ�te post�e sur la base. 
   *   Cette ligne contient un id = -1 pour permettre de la filtrer dans les autres lignes de r�sultat
   *   D�faut: false
   *
   * - entitiesList : entit� ou liste d'entit�s
   *   Filtre les r�sultats pour l'entit� (ou les entit�s) demand�e. Le login utilisateur utilis� doit avoir acc�s aux entit�s demand�es sinon le WS retourne une erreur.
   *   exemple: 11 ou 11,12,13
   *   D�faut: les entit�s autoris�es du compte utilisateur
   *
   * WS output : 
      {
         "categories":[
